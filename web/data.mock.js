...
const _MA_MOCK = {
  ...
  streams: {
    ...
    bySource: [
      { name: "Doomberg", kind: "Substack", weight: 0.92, freshness: "fresh",
      ...
      { name: "Energy Capitalist", kind: "Newsletter", weight: 0.81, freshness: "fresh",
      ...
      { name: "Bianco Research", kind: "Substack", weight: 0.68, freshness: "fresh",
      ...
      { name: "Capitalist Exploits", kind: "Substack", weight: 0.74, freshness: "fresh",
      ...
      { name: "FRED · DGS10", kind: "Data feed", weight: 0.78, freshness: "fresh",
      ...
      { name: "FRED · CPI exp.", kind: "Data feed", weight: 0.78, freshness: "fresh",
        ...
        themes: ["macro"], direction: "supportive" },
      { name: "Goldman GIR (S)", kind: "Sell-side", weight: 0.62, freshness: "1d",
      ...
      { name: "Forward Guidance", kind: "Podcast (RSS)", weight: 0.61, freshness: "1d",
      ...
      { name: "Macro Voices", kind: "Podcast (RSS)", weight: 0.55, freshness: "stale",
      ...
      { name: "ZeroHedge RSS", kind: "RSS", weight: 0.28, freshness: "fresh",
      ...
      { name: "@woodway", kind: "Twitter", weight: 0.42, freshness: "fresh",
